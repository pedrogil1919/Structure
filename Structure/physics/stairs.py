    ...
    def check_collision(self, p, r):
        ...
        if cthc:
            ...
            if ctwr or ctwl:
                ...
                # in the corner.
                return WheelState.Corner, 0, 0
            # Otherwise, the wheel is only in the ground.
            return WheelState.Ground, 0, 0
        ...
        if cthl or cthr:
            ...
            return WheelState.Unstable, 0, 0
